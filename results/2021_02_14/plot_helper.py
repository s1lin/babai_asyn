...
def plot_runtime(n, SNRs, f):
    ...
    #                        columns=['Babai', 'B-seq', 'NT-2', 'NT-6', 'NT-10', 'NT-12'])
    ...
    for j in range(0, 2):
        ...
        for x in range(0, 3):
            ...
            axes2[j, 0].plot(['NT-2', 'NT-6', 'NT-10', 'NT-12'], omp_itr, color=color[x], marker=marker[x], label=labels[init_value + 1])
            axes2[j, 1].plot(['Babai', 'B-seq', 'NT-2', 'NT-6', 'NT-10', 'NT-12'], omp_res, color=color[x], marker=marker[x], label=labels[init_value + 1])
            axes2[j, 2].plot(['Babai', 'B-seq', 'NT-2', 'NT-6', 'NT-10', 'NT-12'], omp_ber, color=color[x], marker=marker[x], label=labels[init_value + 1])
            axes2[j, 3].plot(['Babai', 'B-seq', 'NT-2', 'NT-6', 'NT-10', 'NT-12'], omp_stm, color=color[x], marker=marker[x], label=labels[init_value + 1])
            axes2[j, 4].plot(['NT-2', 'NT-6', 'NT-10', 'NT-12'], omp_spu, color=color[x], marker=marker[x], label=labels[init_value + 1])
...
def plot_qrtime(n, SNRs, f):
    ...
    for j in range(0, 1):
        ...
        for x in range(0, 3):
            ...
            axes2[j + 0, 0].plot(['NT-2', 'NT-6', 'NT-10', 'NT-12'], omp_itr, color=color[x], marker=marker[x],
                                 label=labels[init_value + 1])
            axes2[j + 0, 1].plot(['Babai', 'B-seq', 'NT-2', 'NT-6', 'NT-10', 'NT-12'], omp_res, color=color[x],
                                 marker=marker[x], label=labels[init_value + 1])
            axes2[j + 0, 2].plot(['Babai', 'B-seq', 'NT-2', 'NT-6', 'NT-10', 'NT-12'], omp_ber, color=color[x],
                                 marker=marker[x], label=labels[init_value + 1])

            axes2[j + 1, 0].semilogy(['Babai', 'B-seq', 'NT-2', 'NT-6', 'NT-10', 'NT-12'], omp_stm, color=color[x],
                                     marker=marker[x], label=labels[init_value + 1])
            if init_value + 1 == 0:
                axes2[j + 1, 1].plot(['Babai', 'B-seq', 'NT-2', 'NT-6', 'NT-10', 'NT-12'], omp_qrt, color=color[x],
                                     marker=marker[x], label=labels[init_value + 1])
            axes2[j + 1, 2].semilogy(['Babai', 'B-seq', 'NT-2', 'NT-6', 'NT-10', 'NT-12'], omp_tim, color=color[x],
                                     marker=marker[x], label=labels[init_value + 1])

            axes2[j + 2, 0].semilogy(['NT-2', 'NT-6', 'NT-10', 'NT-12'], omp_spu, color=color[x], marker=marker[x],
                                     label=labels[init_value + 1])
            if init_value + 1 == 0:
                axes2[j + 2, 1].plot(['NT-2', 'NT-6', 'NT-10', 'NT-12'], omp_qrs, color=color[x], marker=marker[x],
                                     label=labels[init_value + 1])
            axes2[j + 2, 2].plot(['NT-2', 'NT-6', 'NT-10', 'NT-12'], omp_tsu, color=color[x], marker=marker[x],
                                 label=labels[init_value + 1])
