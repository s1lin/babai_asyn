...
long test_PBNP() {
    ...
    index d = 0, l = 0, num_trial = 1, snr = 35, k;
    scalar t_qr[4][200][20][2] = {}, t_aspl[4][200][20][2] = {}, t_bnp[4][200][20][2], t_ber[4][200][20][2] = {}, t_total[4][200][20][2] = {}, run_time;
        ...
        for (int n = 50; n <= 400; n *= 2) {
            ...
            for (int qam = 3; qam <= 3; qam++) {
                ...
                for (index n_proc = 5; n_proc <= 30; n_proc += 5) {
                    ...
                    res = helper::find_residual<scalar, index>(cils.A, x_lll, cils.y);
                    printf("PBNP: CORE: %3d, BER: %8.5f, RES: %8.4f, TIME: %8.4f, "
                           "BNP SPU: %8.4f, TOTAL SPU: %8.4f, LLL SPU:%8.4f\n",
                           n_proc, t_ber[d][t][l][k], res, t_bnp[d][t][l][k],
