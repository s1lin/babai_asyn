...
//                        R_R[(static_cast<int>(c_i) + n * input_sizes_idx_1) - 1] = r1[2 * i1 + 1];
//                    }
//                    // 'eo_sils_reduction:73' y_q([i1,i]) = G * y_q([i1,i]);
//                    low_tmp[0] = y_q[static_cast<int>(c_i) - 2];
//                    low_tmp[1] = y_q[static_cast<int>(c_i) - 1];
//                    y_q[static_cast<int>(c_i) - 2] = G[0] * low_tmp[0] + low_tmp[1] * G[2];
//                    y_q[static_cast<int>(c_i) - 1] = low_tmp[0] * G[1] + low_tmp[1] * G[3];
//                    // 'eo_sils_reduction:74' swap(i) = 0;
//                    vi[static_cast<int>(c_i) - 1] = 0.0;
//                }
//            }
...
//                        R_R[(static_cast<int>(c_i) + n * input_sizes_idx_1) - 1] = r1[2 * i1 + 1];
//                    }
//                    //  Apply the Givens rotation to y_q
//                    // 'eo_sils_reduction:104' y_q([i1,i]) = G * y_q([i1,i]);
//                    low_tmp[0] = y_q[static_cast<int>(c_i) - 2];
//                    low_tmp[1] = y_q[static_cast<int>(c_i) - 1];
//                    y_q[static_cast<int>(c_i) - 2] = G[0] * low_tmp[0] + low_tmp[1] * G[2];
//                    y_q[static_cast<int>(c_i) - 1] = low_tmp[0] * G[1] + low_tmp[1] * G[3];
