...
//            int loop_ub;
//            int nn;
//            // 'qrmgs_cp:2' [m, nn] = size(A);
//            nn = n;
//            // 'qrmgs_cp:3' R = zeros(nn, nn);
//            R.resize(n, n);
//            R.clear();
//
//            // 'qrmgs_cp:4' s = zeros(2, nn);
//            s.resize(2, n);
//            loop_ub = n << 1;
//            for (i = 0; i < loop_ub; i++) {
//                s[i] = 0.0;
...
//                s[2 * k] = l * l;
//            }
//            // 'qrmgs_cp:12' for j = 1:nn
//            i = n;
//            for (j = 0; j < i; j++) {
//                double s_idx_1;
//                int i2;
//                unsigned int piv_idx_1;
//                // 'qrmgs_cp:13' [~, l] = min(s(1,j:nn)-s(2,j:nn));
//                if (j + 1 > nn) {
//                    i1 = 0;
//                    i2 = 0;
//                    idx = 0;
...
//                }
//            }
//            // 'qrmgs_cp:32' P = zeros(nn, nn);
//            P.resize(n, n);
//            loop_ub = n * n;
//            for (i = 0; i < loop_ub; i++) {
//                P[i] = 0.0;
//            }
//            // 'qrmgs_cp:33' for j = 1 : nn
//            i = n;
//            for (j = 0; j < i; j++) {
